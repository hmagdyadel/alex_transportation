    ...
    _routes = [
      const BusRouteModel(
        ...
        stops: [
          ...
          BusStopModel(
            id: 'S101-5',
            name: 'AlexBank Downtown HQ',
            nameAr: 'مقر بنك الإسكندرية الرئيسي',
