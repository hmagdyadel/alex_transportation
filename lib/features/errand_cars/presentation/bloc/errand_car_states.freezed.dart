...
part of 'errand_car_states.dart';
...
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is ErrandCarStates<T>);
}
...
/// @nodoc
class $ErrandCarStatesCopyWith<T,$Res>  {
$ErrandCarStatesCopyWith(ErrandCarStates<T> _, $Res Function(ErrandCarStates<T>) __);
}


/// Adds pattern-matching-related methods to [ErrandCarStates].
extension ErrandCarStatesPatterns<T> on ErrandCarStates<T> {
...
class _Initial<T> implements ErrandCarStates<T> {
  const _Initial();
...
@override
String toString() {
    return 'ErrandCarStates<$T>.initial()';
}
...
class Loading<T> implements ErrandCarStates<T> {
  const Loading();
...
@override
String toString() {
    return 'ErrandCarStates<$T>.loading()';
}
...
class SubmittingRequest<T> implements ErrandCarStates<T> {
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is SubmittingRequest<T>);
}
...
class Loaded<T> implements ErrandCarStates<T> {
  const Loaded();
...
@override
String toString() {
    return 'ErrandCarStates<$T>.loaded()';
}
...
class Empty<T> implements ErrandCarStates<T> {
  const Empty();
...
@override
String toString() {
    return 'ErrandCarStates<$T>.empty()';
}
...
class Success<T> implements ErrandCarStates<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of ErrandCarStates
...
@override
String toString() {
    return 'ErrandCarStates<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ErrandCarStatesCopyWith<T, $Res> {
...
class Error<T> implements ErrandCarStates<T> {
...
@override
String toString() {
    return 'ErrandCarStates<$T>.error(message: $message)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $ErrandCarStatesCopyWith<T, $Res> {
