...
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is DriverStates<T>);
}
...
/// @nodoc
class $DriverStatesCopyWith<T,$Res>  {
$DriverStatesCopyWith(DriverStates<T> _, $Res Function(DriverStates<T>) __);
}


/// Adds pattern-matching-related methods to [DriverStates].
extension DriverStatesPatterns<T> on DriverStates<T> {
...
class _Initial<T> implements DriverStates<T> {
  const _Initial();
...
class Loading<T> implements DriverStates<T> {
  const Loading();
...
class Registering<T> implements DriverStates<T> {
  const Registering();
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is Registering<T>);
}
...
@override
String toString() {
    return 'DriverStates<$T>.registering()';
}
...
class StartingTrip<T> implements DriverStates<T> {
  const StartingTrip();
...
class Loaded<T> implements DriverStates<T> {
  const Loaded();
...
class Empty<T> implements DriverStates<T> {
  const Empty();
...
class Success<T> implements DriverStates<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of DriverStates
...
@override
String toString() {
    return 'DriverStates<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $DriverStatesCopyWith<T, $Res> {
...
class Error<T> implements DriverStates<T> {
...
@override
String toString() {
    return 'DriverStates<$T>.error(message: $message)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $DriverStatesCopyWith<T, $Res> {
